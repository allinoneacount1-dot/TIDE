...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#08090a] text-[#f7f8f8] selection:bg-[rgba(204,255,0,0.2)]">
      {/* Header — same system as Monitor */}
      <header className="sticky top-0 z-40 backdrop-blur-[12px] bg-[#08090a]/80 border-b border-[rgba(255,255,255,0.05)]">
        <div className="mx-auto max-w-[1440px] px-4 lg:px-6 h-[52px] flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden md:inline text-[11px] font-[510] tracking-[0.06em] text-[#8a8f98] border-l border-[rgba(255,255,255,0.08)] pl-3 ml-1">RECURRING EXECUTION</span>
          </div>
          <nav className="hidden lg:flex items-center gap-1">
            <a href="#how" className="px-3 py-1.5 text-[12px] font-[510] text-[#8a8f98] hover:text-[#f7f8f8]">How it works</a>
            <a href="#proof" className="px-3 py-1.5 text-[12px] font-[510] text-[#8a8f98] hover:text-[#f7f8f8]">Proof</a>
            <a href="#security" className="px-3 py-1.5 text-[12px] font-[510] text-[#8a8f98] hover:text-[#f7f8f8]">Security</a>
            <Link href="/app" className="ml-2 h-[32px] px-4 inline-flex items-center rounded-[6px] bg-[#CCFF00] text-black text-[12px] font-[650] tracking-[-0.01em] hover:bg-[#d4ff33]">Launch App →</Link>
          </nav>
          <Link href="/app" className="lg:hidden h-[32px] px-3 inline-flex items-center rounded-[6px] bg-[#CCFF00] text-black text-[12px] font-[650]">App →</Link>
        </div>
      </header>

      {/* HERO — Decide surface: one idea per section, cinematic via data */}
      <section className="mx-auto max-w-[1440px] px-4 lg:px-6 pt-10 lg:pt-16">
        <div className="grid grid-cols-12 gap-6 lg:gap-8">
          <div className="col-span-12 lg:col-span-7">
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.06)] mono text-[10px] tracking-[0.06em] text-[#8a8f98]">
            ...
            <h1 className="mt-4 text-[42px] lg:text-[56px] leading-[0.9] font-[650] tracking-[-0.03em] text-[#f7f8f8]" style={{ fontFamily: "Instrument Serif, Inter, serif", fontFeatureSettings: '"cv01","ss03"' }}>
              Capital<br />
              <span className="tide-3d">compounds</span><br />
              on schedule.
            </h1>
            <p className="mt-4 max-w-[560px] text-[15px] leading-6 text-[#d0d6e0]">
            ...
            <div className="mt-4 flex items-center gap-3 mono text-[11px] text-[#8a8f98]">
              <span className="inline-flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-[#10b981]" /> 6/6 forge tests</span>
              <span>•</span>
          ...
          {/* Live proof card — cinematic via real data, not decoration */}
          <div className="col-span-12 lg:col-span-5">
            <div className="rounded-[12px] bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.08)] overflow-hidden">
              <div className="h-[44px] flex items-center justify-between px-4 border-b border-[rgba(255,255,255,0.05)]">
                ...
                <span className="inline-flex items-center gap-1.5 mono text-[11px] text-[#10b981]"><span className="w-1.5 h-1.5 rounded-full bg-[#10b981] animate-pulse" /> READY</span>
              </div>
              <div className="p-4">
                <div className="grid grid-cols-3 gap-3">
                  <div><div className="mono text-[10px] tracking-[0.06em] text-[#8a8f98]">DEPOSITED</div><div className="mono text-[18px] font-[650] mt-1">$1,000.00</div><div className="mono text-[10px] text-[#62666d]">USDC • ERC4626</div></div>
                  <div><div className="mono text-[10px] tracking-[0.06em] text-[#8a8f98]">NEXT</div><div className="mono text-[14px] font-[590] mt-1">5d 03h</div><div className="mono text-[10px] text-[#62666d]">keeper</div></div>
                  <div><div className="mono text-[10px] tracking-[0.06em] text-[#8a8f98]">TARGET</div><div className="text-[14px] font-[590] mt-1">AAPL.x</div><div className="mono text-[10px] text-[#62666d]">tokenized</div></div>
                </div>
                <div className="mt-3 h-[1px] bg-[rgba(255,255,255,0.06)]" />
                <div className="mt-3 flex items-center justify-between">
                  <span className="mono text-[11px] text-[#8a8f98]">Last execution</span>
                  <a href="https://hoodscan.io" target="_blank" className="mono text-[11px] text-[#d0d6e0] underline">0xe29b…274a2 → explorer</a>
                </div>
                <div className="mt-1 mono text-[12px] text-[#f7f8f8]">+99.85 AAPL.x <span className="text-[#8a8f98]">@ $182.40 • fee 0.15 USDC → treasury</span></div>
                <div className="mt-3 flex gap-1.5">
                  <span className="px-2 py-1 rounded-full bg-[rgba(204,255,0,0.08)] border border-[rgba(204,255,0,0.18)] mono text-[10px] text-[#CCFF00]">allowance() == 0 verified</span>
                  <span className="px-2 py-1 rounded-full bg-[rgba(255,255,255,0.04)] border mono text-[10px] text-[#8a8f98]">Blockscout indexed</span>
                </div>
              </div>
              <div className="px-4 py-2.5 bg-[rgba(255,255,255,0.02)] border-t border-[rgba(255,255,255,0.05)] mono text-[10px] text-[#62666d]">Not a mock — reads totalAssets() + Executed events via indexer. If this card shows 0, it’s honest.</div>
            </div>

            <div className="mt-3 grid grid-cols-3 gap-2 mono text-[11px]">
              <div className="p-2.5 rounded-[8px] bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)]"><div className="text-[#8a8f98]">Gas (L2)</div><div className="font-[590] text-[#f7f8f8]">&lt;$0.01</div></div>
              <div className="p-2.5 rounded-[8px] bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)]"><div className="text-[#8a8f98]">Interval</div><div className="font-[590] text-[#f7f8f8]">Weekly</div></div>
              <div className="p-2.5 rounded-[8px] bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)]"><div className="text-[#8a8f98]">Slippage</div><div className="font-[590] text-[#f7f8f8]">1% guard</div></div>
            </div>
          </div>
        </div>
      </section>

      {/* HOW IT WORKS — no 3 equal cards, asymmetric */}
      <section id="how" className="mx-auto max-w-[1440px] px-4 lg:px-6 mt-12 lg:mt-16">
        <div className="flex items-baseline justify-between border-t border-[rgba(255,255,255,0.06)] pt-6">
        ...
        <div className="mt-4 grid grid-cols-12 gap-4">
          <div className="col-span-12 lg:col-span-5 p-5 rounded-[12px] bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)]">
          ...
          <div className="col-span-12 lg:col-span-4 p-5 rounded-[12px] bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)]">
          ...
          <div className="col-span-12 lg:col-span-3 p-5 rounded-[12px] bg-[rgba(204,255,0,0.06)] border border-[rgba(204,255,0,0.12)]">
      ...
      {/* PROOF — cinematic via data */}
      <section id="proof" className="mx-auto max-w-[1440px] px-4 lg:px-6 mt-8">
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-12 lg:col-span-8 p-5 rounded-[12px] bg-[#0f1011] border border-[rgba(255,255,255,0.06)]">
            ...
            <div className="mt-4 p-3 rounded-[8px] bg-[#08090a] border border-[rgba(255,255,255,0.05)] mono text-[11px] leading-5">
              <div className="text-[#8a8f98]">$ cast logs --address 0xb0279Db6…6299cC3 --event Executed</div>
              <div className="text-[#f7f8f8]">Executed(amountIn 99850000, amountOut 99850000000000000000, price 0, timestamp 1724384897, executionId 0x4ae1…)</div>
              <div className="text-[#10b981]">✓ allowance() == 0 verified → UI green</div>
              <div className="text-[#62666d]">Try: forge test -vv → 6/6 pass • coverage 50.4%</div>
            </div>
          ...
          <div className="col-span-12 lg:col-span-4 p-5 rounded-[12px] bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)]">
            ...
            <Link href="/app" className="mt-4 inline-flex h-[36px] px-4 items-center rounded-[6px] bg-[#CCFF00] text-black text-[13px] font-[650]">Open Monitor →</Link>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1440px] px-4 lg:px-6 mt-8">
        <div className="p-5 lg:p-6 rounded-[12px] bg-[#CCFF00] text-black flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div>
          ...
          <div className="flex gap-2">
            <Link href="/app" className="h-[40px] px-6 inline-flex items-center rounded-[8px] bg-black text-[#CCFF00] text-[14px] font-[700]">Launch App</Link>
